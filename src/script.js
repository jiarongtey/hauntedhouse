...
const doorAmbientOcculasionTexture = textureLoader.load(
  "/textures/door/ambientOcculasion.jpg"
);
...
const walls = new THREE.Mesh(
  new THREE.BoxBufferGeometry(4, 2.55, 4),
...
const door = new THREE.Mesh(
  ...
  new THREE.MeshStandardMaterial({
    ...
    aoMap: doorAmbientOcculasionTexture,
